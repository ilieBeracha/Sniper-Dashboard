...
const moods = [
  { name: "Excited", value: "excited", icon: ArrowBigDown, iconColor: "text-white", bgColor: "bg-red-500" },
  { name: "Loved", value: "loved", icon: ArrowBigDown, iconColor: "text-white", bgColor: "bg-pink-400" },
  { name: "Happy", value: "happy", icon: ArrowBigDown, iconColor: "text-white", bgColor: "bg-green-400" },
  { name: "Sad", value: "sad", icon: ArrowBigDown, iconColor: "text-white", bgColor: "bg-yellow-400" },
  { name: "Thumbsy", value: "thumbsy", icon: ArrowBigDown, iconColor: "text-white", bgColor: "bg-blue-500" },
  { name: "I feel nothing", value: null, icon: ArrowBigDown, iconColor: "text-gray-400", bgColor: "bg-transparent" },
];
        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex flex-1 items-center gap-x-6">
            <button type="button" onClick={() => setMobileMenuOpen(true)} className="-m-3 p-3 md:hidden">
              ...
              <ArrowBigDown aria-hidden="true" className="size-5 text-gray-900" />
            </button>
          ...
          <div className="flex flex-1 items-center justify-end gap-x-8">
            <button type="button" className="-m-2.5 p-2.5 text-gray-400 hover:text-gray-500">
              ...
              <ArrowBigDown aria-hidden="true" className="size-6" />
            </button>
              ...
              <div className="flex items-center gap-x-4 sm:gap-x-6">
                ...
                <Menu as="div" className="relative sm:hidden">
                  <MenuButton className="-m-3 block p-3">
                    ...
                    <ArrowBigDown aria-hidden="true" className="size-5 text-gray-500" />
                  </MenuButton>
                ...
                <dl className="flex flex-wrap">
                  ...
                  <div className="mt-6 flex w-full flex-none gap-x-4 border-t border-gray-900/5 px-6 pt-6">
                    <dt className="flex-none">
                      ...
                      <ArrowBigDown aria-hidden="true" className="h-6 w-5 text-gray-400" />
                    </dt>
                      ...
                      <>
                        <div className="relative flex size-6 flex-none items-center justify-center bg-white">
                          {activityItem.type === "paid" ? (
                            <ArrowBigDown aria-hidden="true" className="size-6 text-indigo-600" />
                          ) : (
                          ...
                          <div className="relative">
                            <ListboxButton className="relative -m-2.5 flex size-10 items-center justify-center rounded-full text-gray-400 hover:text-gray-500">
                              <span className="flex items-center justify-center">
                                {selected.value === null ? (
                                  <span>
                                    <ArrowBigDown aria-hidden="true" className="size-5 shrink-0" />
