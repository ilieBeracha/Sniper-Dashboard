      ...
      <div className=" flex flex-col md:flex-row md:items-center md:justify-between">
        {isCommander(userRole) && (
          <button
            ...
            className="mt-4 md:mt-0 flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 px-4 py-2 rounded-lg text-white text-sm font-medium shadow-lg shadow-indigo-900/20 transition-all"
          >
            <Plus size={18} />
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-5 gap-8">
          <div className="xl:col-span-3 order-2 xl:order-1">
            <div className="bg-[#1A1A1A] rounded-xl shadow-xl border border-white/5 overflow-hidden">
