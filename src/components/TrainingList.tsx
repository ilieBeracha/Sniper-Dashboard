  ...
  return (
    <div className="bg-[#1E1E1E] p-6 rounded-2xl shadow-xl col-span-3 border border-white/5 ">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Training Sessions</h2>
      ...
      {trainings.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-10 bg-gray-800/50 rounded-xl text-center border border-white/10">
          ...
          <p className="text-gray-400">
            ...
            <br />
            <span className="text-sm text-gray-500">Schedule a new session to get started.</span>
          </p>
        </div>
      ) : (
