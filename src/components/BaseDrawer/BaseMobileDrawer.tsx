        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full">
            <DialogPanel className="pointer-events-auto w-screen transform transition-all duration-300 ease-in-out data-[closed]:translate-x-full">
              <div className={`flex h-full flex-col overflow-y-auto shadow-2xl ${
                theme === 'dark' 
                  ? 'bg-[#161616] border-l border-zinc-800' 
                  : 'bg-white border-l border-gray-200'
              }`}>
                {/* Header */}
                <div className={`sticky top-0 z-10 px-4 sm:px-6 pt-6 pb-4 ${
                  theme === 'dark' 
                    ? 'bg-[#161616] border-b border-zinc-800' 
