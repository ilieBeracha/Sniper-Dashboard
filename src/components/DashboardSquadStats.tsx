    ...
    <BaseDashboardCard
      header={
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 w-full text-sm">
          <h2 className="font-semibold text-sm text-white flex items-center gap-2 flex-shrink-0">Squad Stats</h2>
        </div>
      }
    >
      <Card className="bg-transparent justify-center rounded-xl w-full h-full flex flex-col items-center gap-4 text-sm text-white">
              ...
              <div className="flex flex-col justify-between sm:flex-row flex-wrap items-start text-sm sm:items-center gap-2 sm:gap-4 w-full lg:w-auto">
                ...
                {(selectedFilter || selectedDistance || selectedPosition) && (
                  <button
                    ...
                    className="w-full sm:w-auto px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-white text-xs rounded-lg transition-colors whitespace-nowrap"
                  >
                    Reset Filters
                  </button>
                )}
