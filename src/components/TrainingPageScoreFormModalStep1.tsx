    ...
    return (
        <form className="w-full rounded-xl p-2 shadow-lg">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-4 justify-center" >
                <ScoreFormField field="day_night" type="select" formValues={formValues} setFormValues={setFormValues} assignmentSessions={assignmentSessions} />
                <ScoreFormField field="position" type="select" formValues={formValues} setFormValues={setFormValues} assignmentSessions={assignmentSessions} />
                <ScoreFormField field="distance" type="number" formValues={formValues} setFormValues={setFormValues} assignmentSessions={assignmentSessions} />
                <ScoreFormField field="target_hit" type="number" formValues={formValues} setFormValues={setFormValues} assignmentSessions={assignmentSessions} />
            </div>
