    ...
    <div className={`h-full flex flex-col relative ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          {isLoading && (
            <div className="flex justify-start animate-in slide-in-from-bottom-2 duration-300">
              <div className={`p-4 text-sm rounded-2xl rounded-bl-md backdrop-blur-sm flex items-center gap-3 shadow-lg ${
                theme === 'dark'
                ...
                <div className="flex gap-1">
                  <div className={`w-2 h-2 rounded-full animate-bounce ${theme === 'dark' ? 'bg-blue-400' : 'bg-blue-600'}`} style={{ animationDelay: "0ms" }}></div>
                  <div className={`w-2 h-2 rounded-full animate-bounce ${theme === 'dark' ? 'bg-blue-400' : 'bg-blue-600'}`} style={{ animationDelay: "150ms" }}></div>
                  <div className={`w-2 h-2 rounded-full animate-bounce ${theme === 'dark' ? 'bg-blue-400' : 'bg-blue-600'}`} style={{ animationDelay: "300ms" }}></div>
                </div>
              </div>
            </div>
          )}
      ...
      <div className={`absolute bottom-0 left-0 right-0 p-4 ${
        ...
        <div className="max-w-4xl mx-auto">
          <div className={`backdrop-blur-xl rounded-2xl shadow-2xl shadow-blue-500/20 overflow-hidden ${
