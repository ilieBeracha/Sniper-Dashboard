...
export default function DashboardProfileCard() {
  ...
  return (
    <div className={`rounded-lg border p-2 ${theme === "dark" ? "bg-zinc-900/50 border-zinc-800" : "bg-white border-gray-200"}`}>
      <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div>
              <div className="flex items-center gap-1.5">
                ...
                {!isMobile && <span className="text-xs opacity-50">{icon}</span>}
              </div>
              <p className="text-[10px] opacity-60">{greeting} Commander</p>
            </div>
            ...
            {!isMobile && (
              <div className="flex items-center gap-2 text-[10px]">
                <span className={`px-1.5 py-0.5 rounded ${theme === "dark" ? "bg-zinc-800 text-zinc-400" : "bg-gray-100 text-gray-600"}`}>
        ...
        {/* Right side - Date */}
        <div className="hidden md:flex items-center gap-1.5 text-[10px] opacity-60">
          <Calendar size={12} />
