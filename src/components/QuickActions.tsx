    ...
    >
      <div className="p-3 ps-0 flex flex-col sm:flex-row sm:items-center gap-y-2 sm:gap-y-0 sm:gap-x-3">
        ...
        <div className="sm:order-1">
          <button
            type="button"
            className="ps-[13px] -ms-px group block text-start border-s-3 border-red-500 focus:outline-hidden"
            data-hs-overlay="#hs-pro-deem"
          >
            <span className="block text-start text-sm font-medium text-gray-800 group-hover:text-blue-600 group-focus:text-blue-600 dark:group-hover:text-blue-500 dark:group-focus:text-blue-500 dark:text-neutral-200">
              12:30 PM - 14:00 PM
            </span>
            <span className="block text-sm text-gray-600 dark:text-neutral-400">Project onboarding with new teammates</span>
          </button>
        </div>
      </div>
      ...
      <div className="p-3 flex items-center gap-x-3">
        <div className="flex items-center gap-x-2">
          ...
          <p className="text-sm text-gray-500 dark:text-neutral-500">3 files attached</p>
        </div>
      ...
      <div className="p-3 flex items-center gap-x-3">
        <h4 className="text-sm text-gray-600 dark:text-neutral-400">Attendees</h4>
        <div className="ms-auto">
