...
function WheelPicker({ classNames, ...props }: React.ComponentProps<typeof WheelPickerPrimitive.WheelPicker>) {
  return (
    <WheelPickerPrimitive.WheelPicker
      classNames={{
        optionItem: "text-zinc-400 dark:text-zinc-500 text-center text-sm",
        highlightWrapper: "bg-zinc-100 text-zinc-950 dark:bg-zinc-800 dark:text-zinc-50 text-center text-sm",
        ...classNames,
      }}
      {...props}
    />
