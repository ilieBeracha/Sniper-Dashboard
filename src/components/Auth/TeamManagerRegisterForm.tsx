      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="block w-full px-4 pr-3 py-2 rounded-md bg-[#0A0A0A] text-gray-300 border border-[#2A2A2A] focus:outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-500 transition-all"
            placeholder="John"
          />
        </div>
